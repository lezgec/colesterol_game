...
if (!function_exists("render_user_menu")) {
    function render_user_menu(): void {
        ...
        if ($role === "player") {
            $profileUrl = app_path("pages/player_profile.php");
            $dashboardUrl = app_path("pages/player_dashboard.php");
            $roleLabel = $lang === "en" ? "Player" : "Jugador";
        } else {
            $profileUrl = app_path("pages/teacher_profile.php");
            $dashboardUrl = app_path("pages/admin_dashboard.php");
        ...
        <details class="user-menu">
            ...
            <nav class="user-menu-panel" aria-label="<?php echo $lang === "en" ? "User menu" : "Menu de usuario"; ?>">
                ...
                <a href="<?php echo app_path("pages/logout.php"); ?>" class="user-menu-danger">
                    <?php echo t("logout"); ?>
                </a>
            </nav>
        </details>
