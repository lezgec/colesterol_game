...
<script src="/colesterol_game/assets/js/password_policy.js?v=<?php echo $passwordPolicyJsVersion; ?>"></script>
<script src="/colesterol_game/assets/js/register.js?v=<?php echo $registerJsVersion; ?>"></script>
