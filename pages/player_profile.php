...
<div class="game-container player-profile-container">
    ...
    <div class="top-actions">
        ...
        <div class="top-links">
            <a href="<?php echo $isAdminProfileView ? app_path('pages/users_management.php') : app_path('pages/player_dashboard.php'); ?>" class="logout-btn secondary-btn">
    ...
    <a href="<?php echo app_path('backend/exports/export_player_profile_csv.php'); ?>"
    class="primary-btn"
    ...
    <a href="<?php echo app_path('backend/exports/pdf/export_player_profile_pdf.php'); ?>"
    class="primary-btn"
    style="display:block; text-align:center; text-decoration:none; margin-bottom:15px;">
    ...
    <section class="admin-section profile-editor-section profile-page-section">
            ...
            <div class="profile-display-main">
                <div class="profile-social-stats">
                    ...
                    <div>
                        ...
                        <span><?php echo current_lang() === "en" ? "Precisión" : "Precisión"; ?></span>
                    </div>
                </div>

                <div class="profile-detail-grid">
                    <div>
                        <span><?php echo current_lang() === "en" ? "Country" : "País"; ?></span>
                    ...
                    <div>
                        <span><?php echo current_lang() === "en" ? "Occupation" : "Ocupación"; ?></span>
        ...
        <form id="profile-form" class="profile-form profile-edit-panel" hidden data-admin-readonly="<?php echo $isAdminProfileView ? '1' : '0'; ?>" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label for="profile-country"><?php echo current_lang() === "en" ? "Country" : "País"; ?></label>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="profile-occupation"><?php echo current_lang() === "en" ? "Occupation" : "Ocupación"; ?></label>
    ...
    <section class="profile-export-actions">
        <a href="<?php echo app_path('backend/exports/export_player_profile_csv.php' . $profileUserParam); ?>" class="primary-btn">
            <?php echo t("export_csv"); ?>
        </a>
        <a href="<?php echo app_path('backend/exports/pdf/export_player_profile_pdf.php' . $profileUserParam); ?>" class="primary-btn">
...
async function loadPublicProfile() {
    const response = await fetch(profileEndpoint(appUrl("backend/users/get_profile.php")));
...
document.getElementById("profile-form").addEventListener("submit", async event => {
    ...
    try {
        const response = await fetch(appUrl("backend/users/update_profile.php"), {
            method: "POST",
            headers: csrfHeaders(),
            body: payload
        });
...
fetch(profileEndpoint(appUrl("backend/reports/player_profile_report.php")))
    .then(res => res.json())
    .then(data => {
        if (!data.success) {
            return;
...
async function loadInsights() {
    ...
    try {
        ...
        const response = await fetch(
            profileEndpoint(appUrl("backend/exports/player_insights_report.php"))
        );
...
async function loadBadges() {
    ...
    try {
        ...
        const response = await fetch(
            profileEndpoint(appUrl("backend/badges/get_user_badges.php"))
        );
