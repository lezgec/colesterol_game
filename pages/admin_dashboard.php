    ...
    <div class="admin-dashboard-layout">
        ...
        <aside class="admin-tools-panel">
            ...
            <div class="admin-tools-list">
                ...
                <a href="/colesterol_game/pages/notifications.php"
                   class="dashboard-card dashboard-link tool-card">
                ...
                <?php if ($canManageUsers): ?>
                    ...
                    <a href="/colesterol_game/pages/email_logs.php"
                       class="dashboard-card dashboard-link tool-card">
...
function renderOpenRooms(rooms) {
    ...
    rooms.forEach(room => {
        ...
        row.innerHTML = `
            ...
            <td>
                <a
                    href="/colesterol_game/pages/rooms/lobby_admin.php?code=${encodeURIComponent(room.room_code)}"
...
fetchDashboardJson(dashboardEndpoint("/colesterol_game/backend/dashboard/get_admin_dashboard.php"))
    .then(result => {
...
fetchDashboardJson(dashboardEndpoint("/colesterol_game/backend/dashboard/get_admin_analytics.php"))
    .then(result => {
        if (!result.success) return;
