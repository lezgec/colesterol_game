...
<div class="game-container player-dashboard-container">
    ...
    <header class="player-dashboard-hero">
        ...
        <a href="<?php echo app_path('pages/game.php'); ?>" class="player-hero-action">
    ...
    <section class="player-actions-section">
        ...
        <a href="<?php echo app_path('pages/game.php'); ?>" class="dashboard-card dashboard-link player-action-card action-play">
            <h3><?php echo ui_icon("gamepad"); ?> <?php echo t("start_solo_game"); ?></h3>
            <p><?php echo t("start_solo_game_description"); ?></p>
        </a>

        <a href="<?php echo app_path('pages/rooms/join.php'); ?>" class="dashboard-card dashboard-link player-action-card action-room">
            <h3><?php echo ui_icon("users"); ?> <?php echo t("join_room"); ?></h3>
            <p><?php echo t("join_room_description"); ?></p>
        </a>

        <a href="<?php echo app_path('pages/history.php'); ?>" class="dashboard-card dashboard-link player-action-card action-history">
            <h3><?php echo ui_icon("analytics"); ?> <?php echo t("history"); ?></h3>
            <p><?php echo t("history_description"); ?></p>
        </a>

        <a href="<?php echo app_path('pages/ranking.php'); ?>" class="dashboard-card dashboard-link player-action-card action-ranking">
            <h3><?php echo ui_icon("trophy"); ?> <?php echo t("ranking"); ?></h3>
            <p><?php echo t("ranking_description"); ?></p>
        </a>

        <a href="<?php echo app_path('index.php'); ?>" class="dashboard-card dashboard-link player-action-card action-public">
            <h3><?php echo ui_icon("home"); ?> <?php echo t("public_view"); ?></h3>
            <p><?php echo t("public_view_description"); ?></p>
        </a>
        <a href="<?php echo app_path('pages/player_profile.php'); ?>" class="dashboard-card dashboard-link player-action-card action-profile">
...
fetch(appUrl(`backend/dashboard/get_dashboard.php?lang=${encodeURIComponent(PLAYER_DASHBOARD_LANG)}`))
    .then(res => res.json())
    .then(data => {
