...
async function loadTeacherProfile() {
    const response = await fetch(teacherProfileEndpoint(appUrl("backend/users/get_profile.php"), TEACHER_PROFILE_TARGET_QUERY));
...
async function loadTeacherDashboardStats() {
    const response = await fetch(teacherProfileEndpoint(appUrl("backend/dashboard/get_admin_dashboard.php"), TEACHER_PROFILE_TARGET_QUERY));
