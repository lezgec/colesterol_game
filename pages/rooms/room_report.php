...
<div class="game-container">
    ...
    <div class="top-actions">
        ...
        <div class="top-links">
            <a href="/colesterol_game/pages/rooms/ranking.php?code=<?php echo urlencode($roomCode); ?>" class="logout-btn secondary-btn">
...
fetch(`/colesterol_game/backend/reports/room_report.php?code=${encodeURIComponent(ROOM_CODE)}`)
    .then(res => res.json())
    .then(data => {
        if (!data.success) {
