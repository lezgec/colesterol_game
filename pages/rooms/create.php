...
<div class="game-container admin-container">
    ...
    <a href="/colesterol_game/pages/admin_dashboard.php" class="secondary-link room-back-link">
...
<script src="/colesterol_game/assets/js/rooms/create_room.js?v=<?php echo $createRoomJsVersion; ?>"></script>
