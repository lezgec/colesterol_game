...
<div class="game-container admin-container">
    ...
    <form id="create-room-form" class="admin-form">
        ...
        <div class="form-group">
            <label><?php echo t("room_name"); ?></label>
