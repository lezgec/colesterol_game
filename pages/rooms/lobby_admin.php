...
function updateBankSelectionState() {
    bankSelectedIds = new Set(
        Array.from(document.querySelectorAll(".room-bank-question-checkbox:checked:not(:disabled)"))
...
async function loadRoomQuestionBank() {
    try {
        const res = await fetch(`/colesterol_game/backend/rooms/get_questions_for_room_setup.php?code=${encodeURIComponent(ROOM_CODE)}&lang=${encodeURIComponent(roomQuestionLanguage || CURRENT_LANG)}`);
...
async function saveRoomSettings() {
    ...
    try {
        ...
        const res = await fetch("/colesterol_game/backend/rooms/update_room_settings.php", {
            method: "POST",
            headers: {"Content-Type": "application/json"},
            body: JSON.stringify({
                room_code: ROOM_CODE,
...
async function addSelectedRoomQuestions() {
    ...
    try {
        ...
        const res = await fetch("/colesterol_game/backend/rooms/add_room_questions.php", {
            method: "POST",
            headers: {"Content-Type": "application/json"},
            body: JSON.stringify({
                room_code: ROOM_CODE,
